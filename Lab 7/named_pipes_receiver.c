...
//copied from Pesteves2002 https://github.com/Pesteves2002/SO-Labs/tree/master/7-Tutorial
...
int main() {
    ...
    ssize_t ret = read(rx, second_pipe, BUFFER_SIZE - 1);   //!reads second pipe name, important for both threads knowing what is what
    second_pipe[ret] = 0;
